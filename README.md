...
- Led UI test automation by integrating Playwright with Testkube, achieving a 70% reduction in test creation effort.
- Implemented a feature for suspending/resuming deployments, ensuring environment consistency during demos.
...
- Developed a JSP full-stack application, enhancing user engagement and conversion rates for thousands of viewers monthly.
- Decreased intern onboarding time by 67% by consolidating landing page projects into a single Maven project.

### Georgia Tech, College of Computing - Teaching Assistant
Atlanta, GA (Jan 2021 – Dec 2023)
- Educated over 400 students in data structures and algorithms, and over 200 in database systems.
...
- Live updates and delivery tracking for buyers
- Efficient task management for deliverers

**Impact:**
- Improved the ease of conducting transactions in online marketplaces
- Enhanced user experience with streamlined delivery process
- Provided a comprehensive solution for delivery needs within existing platforms

**Learnings:**
- Deepened understanding of full-stack development for real-time applications
...
- In-game economy for trading crops and purchasing supplies
- Environmental factors and events that affect farming decisions
...
**Learnings:**
- Enhanced skills in object-oriented programming and software architecture design
...
- Aided in the forecasting of playoff probabilities and potential matchups
- Contributed to sports analytics by developing a novel predictive tool

**Learnings:**
- Advanced understanding of machine learning models and their real-world application in sports analytics
